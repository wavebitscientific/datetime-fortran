...
if (b /= datetime(2020, 2, 29)) error stop 'should be 2020-02-29'

!> subtract
b = b - timedelta(seconds=35)
if (b /= datetime(2020, 2, 28, 23, 59, 25)) error stop 'should be 2020-02-28T23:59:25'
